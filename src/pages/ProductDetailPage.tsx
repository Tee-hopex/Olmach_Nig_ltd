    ...
    <div className="bg-cream-50 min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="grid lg:grid-cols-2 gap-10 mb-16">
          ...
          {/* Details */}
          <div>
            <p className="text-sm text-gold-600 font-semibold uppercase tracking-wide mb-2">
              {product.brand}
            </p>
            <h1 className="text-2xl md:text-3xl font-bold text-navy-900 mb-3 leading-snug">
              {product.name}
            </h1>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-3">
                <div className="flex items-center border border-gray-200 rounded-xl overflow-hidden">
                  <button
                    ...
                    className="px-3 py-3 text-navy-900 hover:bg-cream-100 transition-colors"
                  >
                    <Minus className="w-4 h-4" />
                  </button>
                  <span className="px-4 py-3 font-semibold text-navy-900 min-w-[3rem] text-center">
                    {qty}
                  </span>
                  <button
                    type="button"
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className={`flex items-center gap-2 flex-1 justify-center border-2 py-3 rounded-xl text-sm font-semibold transition-colors ${
                    wished
            ...
            <div className="grid grid-cols-2 gap-3 bg-cream-50 rounded-2xl p-4 border border-gray-100">
              {[
                { icon: ShieldCheck, text: `Warranty: ${product.warranty}`, color: 'text-green-500' },
              ...
              <div>
                <div className="flex items-center gap-4 mb-6">
                  <div className="text-center">
                    <p className="text-4xl font-bold text-navy-900">{product.rating}</p>
                ...
                {[
                  {
                    ...
                    a: `Yes — ${product.warranty}. We handle all warranty claims on your behalf.`,
                  },
                  {
                    q: 'How long does delivery take?',
                    a: 'Lagos orders arrive within 24 hours. Other states within 2–5 business days.',
                  },
                  {
                    q: 'Can I get installation support?',
                    a: 'Yes! Our team provides free setup guidance via WhatsApp and phone call.',
                  },
                  {
                    q: 'Do you accept returns?',
                    a: 'Yes — if the machine is faulty on arrival, we replace it within 7 days.',
                  },
                ].map((item, i) => (
