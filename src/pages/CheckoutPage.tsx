...
import { z } from 'zod';
import { ShieldCheck, ArrowLeft, Landmark, CreditCard, Truck } from 'lucide-react';
              ...
              <div className="bg-white rounded-2xl p-6 shadow-card">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      {...register('address')}
                      placeholder="14 Fabric Lane, Lagos Island"
                      className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-gold-500"
                    />
                    {errors.address && (
                  ...
                  {(
                    [
                      ...
                      },
                      {
                        ...
                        desc: 'Pay securely online via Paystack',
                        Icon: CreditCard,
                      },
                      {
                        value: 'pay_on_delivery',
                        label: 'Pay on Delivery',
                        desc: 'Cash payment when order arrives (Lagos only)',
                        Icon: Truck,
                      },
                  ...
                  {items.map(item => (
                    <div key={item.product.id} className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-medium text-navy-900 line-clamp-2">
                          {item.product.name}
                        </p>
