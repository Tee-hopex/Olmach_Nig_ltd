  ...
  await Promise.all([
    ...
    prisma.brand.upsert({
      ...
      create: {
        ...
        slug: 'yamata',
        description:
          'Yamata produces direct drive industrial sewing machines offering energy-efficient servo motor performance at competitive price points for garment factories.',
      },
    }),
    prisma.brand.upsert({
      where: { slug: 'sewmaster' },
      update: {},
      create: {
        name: 'Sewmaster',
        slug: 'sewmaster',
        description:
          'Sewmaster manufactures industrial sewing machines in the standard 8700 format, widely used in Nigerian tailoring workshops and garment factories.',
      },
    }),
    prisma.brand.upsert({
      where: { slug: 'sew-fine' },
      ...
      create: {
        ...
        slug: 'sew-fine',
        description:
          'Sew Fine produces industrial straight sewing machines offering reliable 8700-format performance for garment production workshops.',
      },
    }),
    prisma.brand.upsert({
      where: { slug: 'sewtec' },
      ...
      create: {
        ...
        slug: 'sewtec',
        description:
          'Sewtec manufactures industrial button tacking and buttonhole machines for professional garment production and tailoring factories.',
      },
    }),
    prisma.brand.upsert({
      where: { slug: 'poolin' },
      ...
      create: {
        ...
        slug: 'poolin',
        description:
          'Poolin produces computerized embroidery and monogram machines for professional garment decoration and personalisation businesses.',
      },
    }),
    prisma.brand.upsert({
      where: { slug: 'galaxy' },
      ...
      create: {
        ...
        slug: 'galaxy',
        description:
          'Galaxy manufactures premium computerized embroidery and monogram machines for high-volume commercial garment decoration.',
      },
    }),
    prisma.brand.upsert({
      where: { slug: 'jukh' },
      ...
      create: {
        ...
        slug: 'jukh',
        description:
          'Jukh produces industrial sewing machines for straight stitching, overlocking, and tapping applications, widely available in Nigerian garment markets.',
      },
    }),
    prisma.brand.upsert({
      where: { slug: 'jukah' },
      ...
      create: {
        ...
        slug: 'jukah',
        description:
          'Jukah manufactures affordable industrial sewing machines in the standard 8700 format for garment factories and tailoring workshops.',
      },
    }),
  ]);
...
An essential finishing tool for tailors offering premium bespoke garment services.`,
    ...
    // ═══════════════════════════════════════════════════════════════════════
    //  BATCH 4 ADDITIONS — INDUSTRIAL STRAIGHT MACHINES
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Emel 810 Industrial Straight Sewing Machine',
      slug: 'emel-810-industrial-straight',
      brand: 'Emel',
      categoryId: catStraight.id,
      subcategory: 'Standard',
      price: 550000,
      images: [PH],
      shortDescription: 'Emel Model 810 industrial straight sewing machine — reliable high-speed lockstitch for garment factories and tailoring workshops.',
      description: `The Emel 810 is a high-speed industrial lockstitch sewing machine from Emel, a well-established sewing machine brand across West Africa. The Model 810 delivers consistent straight stitch performance for garment production including shirts, trousers, school uniforms, and outerwear.

Built for the demands of professional tailoring shops and small factories, the Emel 810 combines dependable construction with ease of maintenance — a trusted choice for Nigerian workshops seeking reliable daily performance at a competitive price.`,
      features: [
        'High-speed industrial lockstitch for straight seam garment production',
        'Robust cast-iron body for long-lasting workshop use',
        'Compatible with a wide range of woven fabrics from lightweight to medium-weight',
        'Simple maintenance and widely available spare parts',
        'Emel brand — established and trusted across West African garment markets',
      ],
      specifications: {
        'Model': '810',
        'Brand': 'Emel',
        'Stitch Type': 'Lockstitch (straight stitch)',
        'Speed': 'High-speed industrial',
        'Use Cases': 'Shirts, trousers, uniforms, outerwear',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['emel', '810', 'industrial', 'straight', 'lockstitch', 'sewing machine', 'garment factory'],
    },
    {
      name: 'Two Lion Post Bed Industrial Sewing Machine – Model 810 (Leather)',
      slug: 'two-lion-810-post-bed',
      brand: 'Two Lion',
      categoryId: catStraight.id,
      subcategory: 'Post Bed',
      price: 550000,
      images: [PH],
      shortDescription: 'Two Lion Model 810 post bed industrial sewing machine — designed for leather goods, bags, shoes, and cylindrical items that flat-bed machines cannot handle.',
      description: `The Two Lion Model 810 Post Bed Industrial Sewing Machine features the distinctive tall cylindrical post arm that allows leather goods, shoes, boots, bags, and gloves to pass freely around the arm during sewing. This configuration is essential for items that cannot be worked on a flat-bed machine.

The 810 model handles all types of leather — natural cowhide, synthetic PU leather, thick canvas, and nylon webbing — with the strong, consistent lockstitch required for durable seams in leather crafting and upholstery. Two Lion's 810 post bed is widely used in Nigerian leather goods production workshops and cobbler shops.`,
      features: [
        'Post bed arm design for sewing leather shoes, bags, boots, and gloves',
        'Handles natural and synthetic leather, canvas, and thick nylon webbing',
        'Strong lockstitch for durable seams in leather goods production',
        'Walking foot or needle-feed mechanism for even advancement of thick materials',
        'Two Lion brand — reliable industrial machines widely used in West Africa',
      ],
      specifications: {
        'Model': '810',
        'Brand': 'Two Lion',
        'Machine Type': 'Post Bed Industrial Sewing Machine',
        'Primary Use': 'Leather goods, shoes, bags, cylindrical items',
        'Materials': 'Leather (natural and synthetic), canvas, PU, heavy nylon',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['two lion', '810', 'post bed', 'leather', 'shoes', 'bags', 'industrial sewing machine', 'cylinder arm', 'cobbler'],
    },
    {
      name: 'Jukky Protex Industrial Leather Sewing Machine – Model 0303',
      slug: 'jukky-protex-0303-leather',
      brand: 'Jukky',
      categoryId: catStraight.id,
      subcategory: 'Leather',
      price: 500000,
      images: [PH],
      shortDescription: 'Jukky Protex Model 0303 heavy-duty industrial sewing machine for all types of leather, hides, and thick synthetic materials.',
      description: `The Jukky Protex 0303 is a heavy-duty industrial sewing machine engineered specifically for leather work — capable of handling all types of natural leather, hides, PU leather, thick canvas, and synthetic materials used in bags, belts, shoes, and upholstery.

The Protex series is built with a heavy feed dog system and reinforced presser foot mechanism to ensure even, consistent advancement of thick and stiff leather materials that standard straight machines cannot handle. Model 0303 is suited for professional leathercraft workshops, cobbler shops, and bag production factories.`,
      features: [
        'Engineered for all types of leather — cowhide, PU, synthetic, and heavy canvas',
        'Heavy-duty feed mechanism for consistent advancement of thick materials',
        'Reinforced presser foot for sewing multi-layer leather without slipping',
        'Strong lockstitch seams suitable for bags, belts, shoes, and upholstery',
        'Model 0303 — reliable for professional leathercraft production',
      ],
      specifications: {
        'Model': '0303',
        'Brand': 'Jukky (Protex series)',
        'Stitch Type': 'Lockstitch',
        'Primary Use': 'Leather goods, bags, shoes, belts, upholstery',
        'Materials': 'Natural leather, PU leather, canvas, synthetic hides',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['jukky', 'protex', '0303', 'leather', 'industrial sewing machine', 'heavy duty', 'bags', 'shoes', 'upholstery'],
    },
    {
      name: 'Jukh Industrial Straight Sewing Machine',
      slug: 'jukh-industrial-straight',
      brand: 'Jukh',
      categoryId: catStraight.id,
      subcategory: 'Standard',
      price: 330000,
      images: [PH],
      shortDescription: 'Jukh industrial straight lockstitch sewing machine for high-speed garment production — reliable and competitively priced for Nigerian tailoring workshops.',
      description: `The Jukh Industrial Straight Sewing Machine is a high-speed lockstitch machine designed for professional garment production in tailoring workshops and small factories. It handles the full range of woven fabrics used in shirt, trouser, uniform, and outerwear production with consistent stitch quality and ease of operation.

Jukh machines offer a competitive combination of industrial performance and accessible pricing, making them a practical choice for workshops seeking reliable straight stitch capability without the premium cost of Japanese brands.`,
      features: [
        'High-speed industrial lockstitch for straight seam garment production',
        'Handles lightweight to medium-weight woven fabrics',
        'Simple threading and operation for workshop efficiency',
        'Widely available spare parts',
        'Competitive pricing for high-volume tailoring operations',
      ],
      specifications: {
        'Brand': 'Jukh',
        'Stitch Type': 'Lockstitch (straight stitch)',
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['jukh', 'industrial', 'straight', 'lockstitch', 'sewing machine', 'garment'],
    },
    {
      name: 'Sewmaster Industrial Straight Sewing Machine – Model 8700',
      slug: 'sewmaster-8700-industrial-straight',
      brand: 'Sewmaster',
      categoryId: catStraight.id,
      subcategory: 'Standard',
      price: 330000,
      images: [PH],
      shortDescription: 'Sewmaster Model 8700 industrial straight sewing machine — a reliable 8700-format lockstitch machine for professional garment production.',
      description: `The Sewmaster 8700 is an industrial straight sewing machine built to the widely used 8700 specification — the standard format for straight-stitch industrial lockstitch machines in Nigerian garment factories and tailoring workshops.

Sewmaster offers solid, production-ready performance at a competitive price point. The 8700 format means parts, needles, and presser feet are widely interchangeable across brands, keeping maintenance simple and downtime low for busy workshops.`,
      features: [
        '8700-format industrial lockstitch — standard for Nigerian garment production',
        'Consistent stitch quality across lightweight to medium-weight fabrics',
        'Widely interchangeable needles and presser feet',
        'Simple maintenance with readily available spare parts',
        'Sewmaster — competitive pricing for professional tailoring',
      ],
      specifications: {
        'Model': '8700',
        'Brand': 'Sewmaster',
        'Stitch Type': 'Lockstitch (straight stitch)',
        'Use Cases': 'Shirts, trousers, school uniforms, general garment work',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['sewmaster', '8700', 'industrial', 'straight', 'lockstitch', 'sewing machine'],
    },
    {
      name: 'Sew Fine Industrial Straight Sewing Machine – Model 8700',
      slug: 'sew-fine-8700-industrial-straight',
      brand: 'Sew Fine',
      categoryId: catStraight.id,
      subcategory: 'Standard',
      price: 330000,
      images: [PH],
      shortDescription: 'Sew Fine Model 8700 industrial straight sewing machine for reliable, high-speed garment production at a competitive price.',
      description: `The Sew Fine 8700 is an industrial lockstitch sewing machine following the proven 8700 format — the industry-standard specification for high-speed straight stitch production in garment factories and tailoring workshops across Nigeria.

Sew Fine machines deliver dependable performance for everyday garment work including shirts, trousers, school uniforms, and outerwear. The 8700 platform ensures compatibility with widely available needles, presser feet, and spare parts, keeping maintenance quick and affordable.`,
      features: [
        '8700-format industrial lockstitch — compatible with standard accessories',
        'Reliable performance for shirts, trousers, uniforms, and outerwear',
        'Simple threading and easy operator learning curve',
        'Wide spare-parts availability across Lagos markets',
        'Sew Fine — quality industrial performance at a competitive price',
      ],
      specifications: {
        'Model': '8700',
        'Brand': 'Sew Fine',
        'Stitch Type': 'Lockstitch (straight stitch)',
        'Use Cases': 'Garment sewing, school uniforms, trousers, shirts',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['sew fine', '8700', 'industrial', 'straight', 'lockstitch', 'sewing machine'],
    },
    {
      name: 'Yamata Direct Drive Industrial Straight Sewing Machine – Model 8700D',
      slug: 'yamata-8700d-direct-drive-straight',
      brand: 'Yamata',
      categoryId: catStraight.id,
      subcategory: 'Direct Drive',
      price: 360000,
      images: [PH],
      shortDescription: 'Yamata Model 8700D direct drive industrial straight sewing machine — servo motor precision with lower energy consumption and quieter operation.',
      description: `The Yamata 8700D is a direct drive industrial lockstitch sewing machine featuring a servo motor integrated directly into the machine head, eliminating the traditional belt-and-clutch system. The result is quieter operation, lower electricity consumption, and more precise speed control from the very first stitch.

Yamata is a recognised Chinese industrial sewing machine brand offering high-performance machines at competitive price points. The 8700D's direct drive mechanism reduces maintenance requirements — no belt adjustment or clutch replacement — making it a smart choice for workshops looking to minimise downtime and running costs.`,
      features: [
        'Direct drive servo motor — no belt or clutch to replace',
        'Quieter and more energy-efficient than clutch motor machines',
        'Precise speed control for consistent stitch quality',
        '8700D format — compatible with standard industrial needles and feet',
        'Yamata brand — quality direct drive machines at competitive pricing',
      ],
      specifications: {
        'Model': '8700D',
        'Brand': 'Yamata',
        ...
        'Stitch Type': 'Lockstitch (straight stitch)',
        'Energy Saving': 'Yes — up to 70% less than clutch motor',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['yamata', '8700d', 'direct drive', 'industrial', 'straight', 'lockstitch', 'servo motor', 'energy saving'],
    },
    {
      name: 'Jukah Industrial Straight Sewing Machine – Model 8700',
      slug: 'jukah-8700-industrial-straight',
      brand: 'Jukah',
      categoryId: catStraight.id,
      subcategory: 'Standard',
      price: 320000,
      images: [PH],
      shortDescription: 'Jukah Model 8700 industrial straight sewing machine — affordable, reliable lockstitch production for Nigerian tailoring workshops.',
      description: `The Jukah 8700 is an industrial straight lockstitch sewing machine in the standard 8700 format — the most widely used specification for garment production in Nigerian tailoring shops and factories. It handles the full range of everyday garment sewing including shirts, trousers, uniforms, and outerwear.

Jukah machines are built for accessibility — competitive pricing, simple operation, and standard spare parts compatibility mean that workshops of all sizes can keep these machines running productively with minimal downtime.`,
      features: [
        '8700-format lockstitch — industry-standard for Nigerian garment production',
        'Handles lightweight to medium-weight woven fabrics consistently',
        'Standard spare parts and needles widely available',
        'Simple operation suitable for tailors of all skill levels',
        'Jukah — competitive entry-level industrial performance',
      ],
      specifications: {
        'Model': '8700',
        'Brand': 'Jukah',
        'Stitch Type': 'Lockstitch (straight stitch)',
        'Use Cases': 'General garment sewing, uniforms, shirts, trousers',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['jukah', '8700', 'industrial', 'straight', 'lockstitch', 'sewing machine', 'affordable'],
    },
    {
      name: 'Jukky Direct Drive Industrial Straight Sewing Machine',
      slug: 'jukky-direct-drive-straight',
      brand: 'Jukky',
      categoryId: catStraight.id,
      subcategory: 'Direct Drive',
      price: 370000,
      images: [PH],
      shortDescription: 'Jukky direct drive industrial straight sewing machine — quiet, energy-efficient servo motor performance for professional garment production.',
      description: `The Jukky Direct Drive Industrial Straight Sewing Machine features a servo motor integrated directly into the machine head, replacing the traditional clutch-and-belt system with a quieter, more responsive direct drive mechanism.

The direct drive eliminates belt wear and clutch adjustment from your maintenance routine, reducing downtime and operating costs. Lower electricity consumption, more consistent stitch quality, and instant responsive speed control make this machine an excellent choice for tailoring workshops running long daily production hours.`,
      features: [
        'Direct drive servo motor — eliminates belt and clutch maintenance',
        'Quiet operation — significantly lower noise than clutch motor machines',
        'Energy-efficient — up to 70% lower electricity consumption',
        'Precise speed control from slow to full industrial speed',
        'Jukky brand — reliable machines at competitive pricing',
      ],
      specifications: {
        'Brand': 'Jukky',
        'Motor Type': 'Direct Drive (Servo)',
        'Stitch Type': 'Lockstitch (straight stitch)',
        'Energy Saving': 'Yes',
        'Use Cases': 'Professional garment production, shirts, trousers, uniforms',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['jukky', 'direct drive', 'industrial', 'straight', 'servo motor', 'energy saving', 'lockstitch'],
    },

    // ═══════════════════════════════════════════════════════════════════════
    //  BATCH 4 ADDITIONS — INDUSTRIAL OVERLOCKING
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Jukh 747 Industrial Weaving Machine (4-Thread Overlock)',
      slug: 'jukh-747-industrial-weaving',
      brand: 'Jukh',
      categoryId: catOverlock.id,
      subcategory: '4-Thread',
      price: 400000,
      images: [PH],
      shortDescription: 'Jukh 747 four-thread industrial overlock machine for professional edge finishing and seaming of garments at production speed.',
      description: `The Jukh 747 is a four-thread industrial overlock machine — commonly referred to in Nigerian garment workshops as a "weaving machine" — designed for high-speed professional edge finishing and seaming.

Using two needles and two loopers, the 747 configuration trims the fabric edge and encases it with a strong, flexible stitch in a single pass, providing the clean, durable seam finish that distinguishes professional garment production. The Jukh 747 is suitable for all standard woven and knit fabrics used in shirts, trousers, dresses, and school uniforms.`,
      features: [
        '4-thread overlock with 2 needles and 2 loopers for strong, flexible seams',
        'Trims and encases fabric edge in one pass for professional finishing',
        'High-speed operation for production-rate garment sewing',
        'Compatible with woven and knit fabrics across garment types',
        'Jukh brand — reliable industrial performance at competitive pricing',
      ],
      specifications: {
        'Model': '747',
        'Brand': 'Jukh',
        'Thread Count': '4-thread',
        'Needle Count': '2 needles, 2 loopers',
        'Use Cases': 'Edge finishing, seaming, garment production',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['jukh', '747', 'overlock', 'weaving machine', '4-thread', 'industrial', 'edge finishing', 'serger'],
    },
    {
      name: 'Jukae 1404 Elasticator Industrial Machine (8-Thread 4-Needle)',
      slug: 'jukae-1404-elasticator',
      brand: 'Jukae',
      categoryId: catOverlock.id,
      subcategory: 'Elasticator',
      price: 1500000,
      images: [PH],
      shortDescription: 'Jukae 1404 eight-thread four-needle industrial elasticator machine — specialist overlock for applying elastic to waistbands, cuffs, and stretch garment edges.',
      description: `The Jukae 1404 is a specialist industrial elasticator machine using 8 threads across 4 needles to produce wide, secure elastic application seams in a single pass. This configuration is used specifically for attaching elastic waistbands, cuffs, sock tops, underwear leg openings, and stretch garment hems where standard overlock machines cannot provide the required elastic hold and coverage width.

With 4 needles working simultaneously, the 1404 creates a wide, multi-row stitch pattern that distributes elastic tension evenly across the seam — essential for activewear, sportswear, underwear, and swimwear production. The Jukae 1404 is a high-capability specialist machine for workshops producing stretch garments at volume.`,
      features: [
        '8-thread, 4-needle configuration for wide elastic application seams',
        'Specialist elasticator for waistbands, cuffs, sock tops, and leg openings',
        'Wide stitch coverage distributes elastic tension evenly across the seam',
        'Essential for activewear, sportswear, underwear, and swimwear production',
        'Jukae brand — industrial-grade specialist machines',
      ],
      specifications: {
        'Model': '1404',
        'Brand': 'Jukae',
        'Thread Count': '8-thread',
        'Needle Count': '4 needles',
        'Machine Type': 'Elasticator',
        'Primary Use': 'Elastic application — waistbands, cuffs, sock tops, leg openings',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['jukae', '1404', 'elasticator', '8-thread', '4-needle', 'industrial', 'elastic', 'waistband', 'activewear', 'overlock'],
    },

    // ═══════════════════════════════════════════════════════════════════════
    //  BATCH 4 ADDITIONS — WEAVING MACHINES
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Two Lion 737 Three-Thread Industrial Weaving Machine',
      slug: 'two-lion-737-three-thread-weaving',
      brand: 'Two Lion',
      categoryId: catWeaving.id,
      subcategory: '3-Thread',
      price: 420000,
      images: [PH],
      shortDescription: 'Two Lion 737 three-thread industrial weaving (overlock) machine — produces strong, flexible seams for stretch fabrics and knitwear at production speed.',
      description: `The Two Lion 737 Three-Thread Industrial Weaving Machine is a 3-thread overlock machine producing the classic three-thread overlock stitch used for seaming and edge finishing on stretch fabrics, knitwear, and jersey garments. Unlike the 4-thread overlock, the 3-thread configuration produces a lighter, softer seam with greater stretch — preferred for T-shirts, athletic wear, and lighter knit garments.

In Nigerian garment workshops, this class of machine is commonly called a "weaving machine." The Two Lion 737 delivers consistent, production-rate performance on cotton knit, polyester, nylon, and blended stretch fabrics.`,
      features: [
        '3-thread overlock configuration — lighter, stretchier seam for knit fabrics',
        'Trims and encases fabric edge in a single pass',
        'High-speed production suitable for T-shirts, athletic wear, and knitwear',
        'Soft, flexible seam ideal for garments that require stretch recovery',
        'Two Lion brand — trusted industrial machines across West Africa',
      ],
      specifications: {
        'Model': '737',
        'Brand': 'Two Lion',
        'Thread Count': '3-thread',
        'Machine Type': 'Industrial Overlock (Weaving Machine)',
        'Best For': 'Stretch fabrics, knitwear, jersey, T-shirts',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['two lion', '737', '3-thread', 'overlock', 'weaving machine', 'industrial', 'knit', 'jersey', 'stretch'],
    },
    {
      name: 'India Juki Semi Industrial Weaving Machine (Head + Electric)',
      slug: 'india-juki-semi-industrial-weaving-electric',
      brand: 'Juki',
      categoryId: catWeaving.id,
      subcategory: 'Semi-Industrial',
      price: 150000,
      images: [PH],
      shortDescription: 'India Juki semi industrial weaving (overlock) machine — head and electric motor unit for edge finishing and seaming in tailoring shops.',
      description: `The India Juki Semi Industrial Weaving Machine is a semi-industrial overlock machine — commonly known as a "weaving machine" in Nigerian markets — supplied as the head unit with electric motor included. It bridges the gap between domestic overlock machines and full industrial overlocks, offering improved speed and durability over home machines while remaining accessible in price.

Suited for tailoring shops, fashion designers, and small workshops that need reliable overlock seaming and edge finishing without the full industrial footprint. This listing covers the head and electric motor unit — stand and table are not included.`,
      features: [
        'Semi-industrial overlock for professional edge finishing and seaming',
        'Head + electric motor included (stand and table not included)',
        'Faster and more durable than domestic overlock machines',
        'Suitable for woven and light knit fabrics',
        'Juki brand semi-industrial quality at an accessible price',
      ],
      specifications: {
        'Brand': 'Juki (India Semi-Industrial)',
        'Machine Type': 'Semi-Industrial Overlock (Weaving Machine)',
        'Contents': 'Head + Electric Motor',
        'Stand/Table': 'Not included',
        'Best For': 'Tailoring shops, fashion designers, small workshops',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: null,
      tags: ['juki', 'semi industrial', 'weaving machine', 'overlock', 'india', 'head and electric', 'edge finishing'],
    },
    {
      name: 'India Juki Semi Industrial Weaving Machine (Complete – Electric + Manual)',
      slug: 'india-juki-semi-industrial-weaving-complete',
      brand: 'Juki',
      categoryId: catWeaving.id,
      subcategory: 'Semi-Industrial',
      price: 190000,
      images: [PH],
      shortDescription: 'India Juki semi industrial weaving (overlock) machine — complete set with both electric and manual operation capability.',
      description: `The India Juki Semi Industrial Weaving Machine Complete Set includes both electric and manual operation configurations, giving your workshop maximum flexibility. The electric setup handles fast, production-rate overlock seaming, while the manual option allows operation during power cuts — essential for Lagos workshops running without generator backup.

The complete set is ideal for tailoring shops and fashion designers who need reliable edge finishing and seaming regardless of electricity availability. This listing covers the full configuration including stand, table, and both electric and manual drive mechanisms.`,
      features: [
        'Complete set — electric motor + manual (treadle) operation',
        'Power-cut resilient: switch to manual mode during outages',
        'Semi-industrial overlock for edge finishing and seaming',
        'Full set includes stand, table, and both drive mechanisms',
        'Juki semi-industrial quality for tailoring shops and designers',
      ],
      specifications: {
        'Brand': 'Juki (India Semi-Industrial)',
        'Machine Type': 'Semi-Industrial Overlock (Weaving Machine)',
        'Contents': 'Complete set — electric + manual drive, stand, table',
        'Operation Modes': 'Electric and manual (treadle)',
        'Best For': 'Tailoring shops, fashion designers, workshops with irregular power',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: null,
      tags: ['juki', 'semi industrial', 'weaving machine', 'overlock', 'india', 'complete set', 'electric and manual', 'edge finishing'],
    },
    {
      name: '3-Thread Inner Weaving Machine – Model 113D (Head + Electric)',
      slug: 'three-thread-inner-weaving-113d',
      brand: 'Generic',
      categoryId: catWeaving.id,
      subcategory: '3-Thread',
      price: 115000,
      images: [PH],
      shortDescription: '3-thread industrial inner weaving (overlock) machine, Model 113D — head and electric unit for lightweight seaming and edge finishing.',
      description: `The 3-Thread Inner Weaving Machine Model 113D is an industrial 3-thread overlock machine suitable for edge finishing and seaming on lightweight to medium-weight fabrics. The "inner weaving" configuration refers to the machine's use for lighter seaming applications — producing a clean, flexible 3-thread overlock stitch.

This listing covers the head and electric motor unit. The 113D model is a dependable, entry-level industrial overlock choice for tailoring shops needing reliable edge finishing at an accessible price.`,
      features: [
        '3-thread industrial overlock for edge finishing and seaming',
        'Model 113D — head and electric motor included',
        'Suitable for lightweight to medium-weight woven and knit fabrics',
        'Consistent overlock stitch quality for garment finishing',
        'Accessible entry-level industrial overlock pricing',
      ],
      specifications: {
        'Model': '113D',
        'Thread Count': '3-thread',
        'Machine Type': 'Industrial Overlock (Inner Weaving Machine)',
        'Contents': 'Head + Electric Motor',
        'Best For': 'Lightweight garment edge finishing and seaming',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: null,
      tags: ['overlock', 'weaving machine', '3-thread', '113d', 'inner weaving', 'industrial', 'edge finishing', 'head and electric'],
    },

    // ═══════════════════════════════════════════════════════════════════════
    //  BATCH 4 ADDITIONS — TAPPING & HEMMING
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Jukh Industrial Tapping Machine – Model 500-2',
      slug: 'jukh-tapping-500-2',
      brand: 'Jukh',
      categoryId: catTapping.id,
      subcategory: 'Tapping',
      price: 620000,
      images: [PH],
      shortDescription: 'Jukh Model 500-2 industrial tapping machine — automates belt loop folding and attachment for high-volume trouser and jeans production.',
      description: `The Jukh Model 500-2 Industrial Tapping Machine is a dedicated machine for the high-speed production of belt loops on trousers, shorts, jeans, and skirts. It automates the complete belt loop attachment process — folding the tape to the correct width, positioning it, and stitching it to the garment — in one continuous operation.

The 500-2 model delivers consistent belt loop width, spacing, and positioning across every garment in a production run, at speeds far beyond manual methods. The Jukh 500-2 is suited for tailoring workshops and small factories running trousers and denim garments at volume.`,
      features: [
        'Automates belt loop folding, positioning, and stitching in one operation',
        'Consistent loop width and positioning across entire production runs',
        'Model 500-2 — standard tapping machine format for trouser production',
        'Works on denim, canvas, suiting, and woven fabrics',
        'Jukh brand — reliable industrial machines at competitive pricing',
      ],
      specifications: {
        'Model': '500-2',
        'Brand': 'Jukh',
        'Machine Type': 'Industrial Tapping Machine (Belt Loop)',
        'Primary Use': 'Belt loop attachment on trousers, shorts, jeans, skirts',
        'Materials': 'Denim, canvas, suiting, woven fabrics',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['jukh', '500-2', 'tapping machine', 'belt loop', 'industrial', 'trouser', 'jeans'],
    },

    // ═══════════════════════════════════════════════════════════════════════
    //  BATCH 4 ADDITIONS — HEAT TRANSFER
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Kingy 38×38 Heat Press Machine',
      slug: 'kingy-38x38-heat-press',
      brand: 'Kingy',
      categoryId: catHeat.id,
      subcategory: 'Heat Press',
      price: 165000,
      images: [PH],
      shortDescription: 'Kingy 38×38 cm heat press machine — apply HTV vinyl, rhinestone transfers, and heat-fix embellishments to garments with digital temperature control.',
      description: `The Kingy 38×38 Heat Press Machine is a flat-bed heat press with a 38 cm × 38 cm platen, providing ample working area for full-chest transfers, large motif applications, and uniform decoration. Kingy machines offer reliable heat press performance at an accessible price point — a popular choice for custom T-shirt businesses, school uniform decorators, and boutique fashion designers in Nigeria.

Digital temperature control ensures accurate, repeatable results across sessions. The 38×38 platen size is the industry standard for most garment decoration applications, covering the majority of heat transfer jobs without repositioning.`,
      features: [
        '38×38 cm platen — covers full chest area in a single press',
        'Digital temperature control for accurate, repeatable results',
        'Even pressure distribution across the full platen area',
        'Compatible with HTV vinyl, rhinestone transfers, and sublimation paper',
        'Kingy brand — reliable heat press performance at competitive pricing',
      ],
      specifications: {
        'Brand': 'Kingy',
        'Platen Size': '38 cm × 38 cm',
        'Temperature Range': '0–230°C',
        'Applications': 'HTV vinyl, rhinestones, glitter motifs, sublimation',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['kingy', 'heat press', '38x38', 'heat transfer', 'rhinestone', 'vinyl', 'garment decoration'],
    },
    {
      name: 'Two Lion 38×38 Heat Transfer Stoning Machine',
      slug: 'two-lion-38x38-heat-transfer-stoning',
      brand: 'Two Lion',
      categoryId: catHeat.id,
      subcategory: 'Stoning',
      price: 300000,
      images: [PH],
      shortDescription: 'Two Lion 38×38 cm heat transfer stoning machine — apply rhinestones, motifs, and HTV transfers precisely and permanently to garments.',
      description: `The Two Lion 38×38 Heat Transfer Stoning Machine is a professional heat press designed for applying rhinestone transfers, glitter motifs, and heat-fix embellishments to garments. The 38 cm × 38 cm platen covers the full chest area in a single press, making it efficient for custom fashion, uniform decoration, and boutique embellishment work.

Two Lion's heat transfer machine delivers consistent temperature control and even pressure across the full platen, ensuring rhinestones and transfers bond permanently to cotton, polyester, and blended fabrics. Trusted by Nigerian fashion designers and decoration businesses for reliable daily use.`,
      features: [
        '38×38 cm platen — covers full garment chest in one press',
        'Consistent temperature and pressure for permanent rhinestone bonding',
        'Compatible with rhinestone transfers, HTV vinyl, glitter motifs, and sublimation',
        'Two Lion brand — trusted across Nigerian garment and decoration markets',
        'Digital controls for accurate temperature setting',
      ],
      specifications: {
        'Brand': 'Two Lion',
        'Platen Size': '38 cm × 38 cm',
        'Application Types': 'Rhinestones, HTV vinyl, glitter motifs, heat transfers',
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['two lion', 'heat press', '38x38', 'stoning', 'rhinestone', 'heat transfer', 'garment decoration'],
    },

    // ═══════════════════════════════════════════════════════════════════════
    //  BATCH 4 ADDITIONS — MANUAL MACHINES
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'UK Used Dress Manual Sewing Machine',
      slug: 'uk-used-dress-manual-machine',
      brand: 'Generic',
      categoryId: catManual.id,
      subcategory: 'UK Used',
      price: 120000,
      images: [PH],
      shortDescription: 'UK used manual (treadle) dress sewing machine — professionally sourced, tested, and ready for tailoring shops and home sewers.',
      description: `The UK Used Dress Manual Sewing Machine is a foot-pedal treadle sewing machine sourced from the United Kingdom, tested and confirmed in working condition. UK used manual machines are highly regarded in Nigerian tailoring markets for their robust, long-lasting build quality.

The dress manual machine is a straight stitch treadle machine ideal for garment sewing, dress making, and general tailoring work. It requires no electricity — foot pedal power drives the machine entirely — making it perfect for workshops with irregular power supply or those seeking a reliable backup machine.`,
      features: [
        'UK sourced — robust, durable build quality from imported pre-owned machine',
        'No electricity required — treadle foot-pedal drive',
        'Straight stitch for garment sewing, dress making, and tailoring',
        'Tested and confirmed working condition before sale',
        'Ideal backup machine or primary tool for power-cut-prone workshops',
      ],
      specifications: {
        'Condition': 'UK Used — tested and confirmed working',
        'Drive': 'Manual treadle (foot pedal)',
        'Stitch Type': 'Straight stitch',
        'Power Requirement': 'None (manual operation)',
        'Best For': 'Dress making, garment sewing, tailoring',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: null,
      warranty: null,
      tags: ['manual machine', 'treadle', 'uk used', 'dress machine', 'no electricity', 'sewing machine'],
    },
    {
      name: 'Two Lion Manual Sewing Machine (2-Drawer)',
      slug: 'two-lion-manual-machine-2-drawer',
      brand: 'Two Lion',
      categoryId: catManual.id,
      subcategory: 'Manual',
      price: 150000,
      images: [PH],
      shortDescription: 'Two Lion 2-drawer manual (treadle) sewing machine — complete with two-drawer wooden stand for organised storage of sewing accessories.',
      description: `The Two Lion Manual Sewing Machine with 2-Drawer Stand is a complete manual treadle sewing machine set including the machine head, iron stand, table, and a 2-drawer storage compartment for keeping threads, bobbins, scissors, and accessories organised.

The Two Lion manual machine requires no electricity — the treadle foot pedal drives the machine entirely — making it reliable through power cuts. The 2-drawer configuration is a practical upgrade over standard manual machine stands for tailors who need their tools organised and close at hand throughout the working day.`,
      features: [
        '2-drawer wooden stand for organised thread, bobbin, and accessory storage',
        'No electricity required — treadle foot-pedal driven',
        'Complete set: head, stand, table, drawers included',
        'Straight stitch for all standard garment sewing applications',
        'Two Lion brand — reliable and widely serviced across Nigeria',
      ],
      specifications: {
        'Brand': 'Two Lion',
        'Drive': 'Manual treadle (foot pedal)',
        'Stitch Type': 'Straight stitch',
        'Stand': 'Iron stand with 2-drawer wooden table included',
        'Power Requirement': 'None (manual operation)',
      },
      inStock: true,
      stockCount: 1,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['two lion', 'manual machine', 'treadle', '2 drawer', 'no electricity', 'sewing machine', 'complete set'],
    },
    {
      name: 'Manual Sewing Machine',
      slug: 'generic-manual-sewing-machine-160k',
      brand: 'Generic',
      categoryId: catManual.id,
      subcategory: 'Manual',
      price: 160000,
      images: [PH],
      shortDescription: 'Standard manual (treadle) sewing machine — reliable straight stitch performance for home tailors and small workshops with no electricity requirement.',
      description: `The Manual Sewing Machine is a standard treadle-operated straight stitch machine suited for home tailors, fashion students, and small workshops requiring an electricity-free sewing solution. Driven entirely by foot pedal, it handles the full range of everyday garment sewing including shirts, dresses, trousers, and school uniforms.

Manual sewing machines remain popular across Nigeria for their resilience in environments with irregular power supply, their low running costs, and their simple, durable mechanical design that rarely requires professional servicing.`,
      features: [
        'No electricity required — foot pedal (treadle) driven',
        'Straight stitch for everyday garment sewing',
        'Durable mechanical design with low maintenance requirements',
        'Suitable for home tailors, fashion students, and small workshops',
        'Resilient performance through power cuts and irregular electricity supply',
      ],
      specifications: {
        'Drive': 'Manual treadle (foot pedal)',
        'Stitch Type': 'Straight stitch',
        'Power Requirement': 'None (manual operation)',
        'Best For': 'Home tailoring, fashion students, workshops with irregular power',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: null,
      tags: ['manual machine', 'treadle', 'no electricity', 'straight stitch', 'home tailor', 'sewing machine'],
    },
    {
      name: 'Jukky Manual Sewing Machine',
      slug: 'jukky-manual-machine',
      brand: 'Jukky',
      categoryId: catManual.id,
      subcategory: 'Manual',
      price: 140000,
      images: [PH],
      shortDescription: 'Jukky brand manual (treadle) sewing machine — reliable electricity-free straight stitch for home tailors and small workshops.',
      description: `The Jukky Manual Sewing Machine is a treadle-operated straight stitch machine from Jukky — a brand known for reliable machines suited to home tailors, fashion school training, and small workshops that need electricity-free operation.

Driven entirely by foot pedal, the Jukky manual machine handles shirts, dresses, trousers, and everyday garment sewing without any electricity requirement. Its straightforward mechanical design keeps maintenance simple and repair costs low — an ideal first machine or reliable backup for tailors running in environments with inconsistent power supply.`,
      features: [
        'No electricity required — foot pedal treadle driven',
        'Straight stitch for everyday garment sewing',
        'Simple mechanical design with easy, low-cost maintenance',
        'Jukky brand — proven reliability for home tailors and training',
        'Ideal first machine or power-cut backup for established workshops',
      ],
      specifications: {
        'Brand': 'Jukky',
        'Drive': 'Manual treadle (foot pedal)',
        'Stitch Type': 'Straight stitch',
        'Power Requirement': 'None (manual operation)',
        'Best For': 'Home tailoring, fashion training, workshops with irregular power',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['jukky', 'manual machine', 'treadle', 'no electricity', 'straight stitch', 'home tailor'],
    },
    {
      name: 'Two Lion Manual Sewing Machine with India Industrial Stand',
      slug: 'two-lion-manual-machine-india-stand',
      brand: 'Two Lion',
      categoryId: catManual.id,
      subcategory: 'Manual',
      price: 140000,
      images: [PH],
      shortDescription: 'Two Lion manual (treadle) sewing machine fitted with a heavy-duty India industrial stand — built for demanding daily workshop use.',
      description: `The Two Lion Manual Sewing Machine with India Industrial Stand combines the Two Lion manual machine head with a heavy-duty India-pattern industrial iron stand — the robust stand type widely favoured in Nigerian tailoring workshops for its durability and stable footprint.

The India industrial stand provides a sturdier, more stable base than standard manual machine stands, making it well-suited to high-use workshop environments. No electricity required — the treadle foot pedal drives the machine entirely. The Two Lion brand is well-established across West Africa with widely available spare parts and service support.`,
      features: [
        'Two Lion manual machine head on heavy-duty India industrial iron stand',
        'India-pattern stand — stronger, more stable than standard manual stands',
        'No electricity required — treadle foot-pedal driven',
        'Straight stitch for garment sewing and tailoring work',
        'Two Lion brand — widely serviced and spare parts available across Nigeria',
      ],
      specifications: {
        'Brand': 'Two Lion',
        'Drive': 'Manual treadle (foot pedal)',
        'Stand': 'India industrial iron stand (heavy-duty)',
        'Stitch Type': 'Straight stitch',
        'Power Requirement': 'None (manual operation)',
      },
      inStock: true,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['two lion', 'manual machine', 'treadle', 'india stand', 'industrial stand', 'no electricity', 'sewing machine'],
    },

    // ═══════════════════════════════════════════════════════════════════════
    //  BATCH 4 ADDITIONS — STEAMING & PRESSING
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Jukky Industrial Steaming Iron',
      slug: 'jukky-industrial-steaming-iron',
      brand: 'Jukky',
      categoryId: catSteaming.id,
      subcategory: 'Steam Iron',
      price: 70000,
      images: [PH],
      shortDescription: 'Jukky brand industrial steaming iron for professional garment pressing — heavy-duty gravity-feed steam iron for tailoring shops.',
      description: `The Jukky Industrial Steaming Iron is a Jukky-branded heavy-duty gravity-feed steam iron designed for professional garment pressing in tailoring shops and small factories. It delivers the high steam output and large soleplate coverage required for setting seams, pressing collars and cuffs, shaping garment panels, and eliminating wrinkles from finished garments.

Jukky industrial steaming irons offer reliable daily-use performance at an accessible price. The gravity-feed water tank provides continuous steam supply during extended pressing sessions without the need for frequent refills.`,
      features: [
        'Heavy-duty gravity-feed steam iron for professional garment finishing',
        'Large soleplate for even heat distribution across fabric',
        'High steam output for setting seams and pressing tailored garments',
        'Gravity-feed tank for continuous steam during extended pressing sessions',
        'Jukky brand — reliable pressing tools at competitive pricing',
      ],
      specifications: {
        'Brand': 'Jukky',
        'Type': 'Gravity-feed industrial steam iron',
        'Primary Use': 'Garment pressing and finishing in tailoring shops',
        'Water System': 'Gravity-feed external tank',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: null,
      tags: ['jukky', 'steam iron', 'industrial', 'pressing', 'garment finishing', 'gravity feed'],
    },
    {
      name: '26-Inch Steam Press Machine',
      slug: '26-inch-steam-press-machine',
      brand: 'Generic',
      categoryId: catSteaming.id,
      subcategory: 'Steam Press',
      price: 240000,
      images: [PH],
      shortDescription: '26-inch steam press machine for professional garment pressing — large platen area for shirts, trousers, and formal wear finishing.',
      description: `The 26-Inch Steam Press Machine is a professional flat-bed steam press with a 26-inch pressing surface — significantly larger than a standard steam iron — allowing complete shirt fronts, trouser legs, and jacket panels to be pressed in a single placement without repositioning.

Steam press machines combine the pressing power of steam with the mechanical pressure of a closing platen, delivering superior results to hand ironing on tailored garments, formal wear, and heavily structured pieces. The 26-inch format is the most versatile size for general garment pressing in tailoring shops and small factories.`,
      features: [
        '26-inch pressing surface — press full garment panels in one placement',
        'Mechanical platen pressure combined with steam for superior pressing results',
        'Faster and more consistent than hand ironing on structured garments',
        'Suitable for shirts, trousers, jackets, and formal wear finishing',
        'Professional steam press quality for tailoring shops and small factories',
      ],
      specifications: {
        'Press Width': '26 inches',
        'Machine Type': 'Flat-bed steam press',
        'Primary Use': 'Professional garment pressing and finishing',
        'Best For': 'Shirts, trousers, formal wear, tailored garments',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['steam press', '26 inch', 'garment pressing', 'industrial', 'finishing', 'shirt press', 'trouser press'],
    },

    // ═══════════════════════════════════════════════════════════════════════
    //  BATCH 4 ADDITIONS — EMBROIDERY & MONOGRAM MACHINES
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Two Lion 500/800 Monogram Machine',
      slug: 'two-lion-500-800-monogram',
      brand: 'Two Lion',
      categoryId: catEmbroidery.id,
      subcategory: 'Monogram',
      price: 0,
      images: [PH],
      shortDescription: 'Two Lion 500/800 single-head industrial monogram (embroidery) machine for producing logos, monograms, and decorative embroidery designs.',
      description: `The Two Lion 500/800 Monogram Machine is a single-head computerized embroidery machine with a 500mm × 800mm embroidery field — providing a generous working area for large logos, full garment-back designs, and multi-placement embroidery work.

With its large hoop capacity and computer-controlled needle movement, the Two Lion 500/800 is suited for fashion designers, school uniform businesses, and garment decorators producing branded clothing, personalised items, and embroidered workwear. The Two Lion brand brings reliable industrial performance to the embroidery category.`,
      features: [
        ...
        'Two Lion brand industrial reliability in embroidery',
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['two lion', '500/800', 'monogram', 'embroidery machine', 'industrial', 'logo', 'uniform branding'],
    },
    {
      name: 'Poolin S7 Single-Head 12-Needle Monogram Machine',
      slug: 'poolin-s7-monogram',
      brand: 'Poolin',
      categoryId: catEmbroidery.id,
      subcategory: 'Monogram',
      price: 2000000,
      images: [PH],
      shortDescription: 'Poolin S7 single-head 12-needle industrial monogram (embroidery) machine — 12 colour changes for complex, multi-colour embroidery without manual re-threading.',
      description: `The Poolin S7 is a single-head, 12-needle computerized monogram machine capable of executing complex, multi-colour embroidery designs with automatic needle switching between up to 12 thread colours. This eliminates the need to manually change thread colours during production, dramatically improving throughput on complex embroidery work.

The S7 format is a popular commercial embroidery configuration used by fashion designers, uniform decorators, and personalisation businesses producing branded clothing, monogrammed garments, and embroidered accessories at scale. Poolin machines deliver high-precision embroidery with reliable, production-tested performance.`,
      features: [
        '12-needle configuration — automatic switching between 12 thread colours',
        'No manual re-threading for colour changes — maximises production efficiency',
        'Single-head format for precision, flexible commercial embroidery work',
        'S7 model — proven performance for fashion designers and decorators',
        'Poolin brand — high-precision computerized embroidery machinery',
      ],
      specifications: {
        'Brand': 'Poolin',
        'Model': 'S7',
        'Head Configuration': 'Single head',
        'Needles': '12 needles (12-colour capacity)',
        'Best For': 'Multi-colour logos, monograms, branded uniforms, personalised garments',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['poolin', 's7', 'monogram', 'embroidery machine', '12 needle', 'single head', 'multi-colour', 'industrial'],
    },
    {
      name: 'Galaxy 500/800E Single-Head 12-Needle Industrial Monogram Machine',
      slug: 'galaxy-500-800e-monogram',
      brand: 'Galaxy',
      categoryId: catEmbroidery.id,
      subcategory: 'Monogram',
      price: 6500000,
      images: [PH],
      shortDescription: 'Galaxy 500/800E single-head 12-needle industrial monogram machine — large 500×800mm embroidery field with 12-colour automatic needle switching.',
      description: `The Galaxy 500/800E is a premium single-head industrial monogram machine combining a large 500mm × 800mm embroidery field with a 12-needle automatic colour-switching system. The large format allows full back designs, oversized logos, and complex multi-placement embroidery work, while the 12-needle head eliminates manual thread changes between colours.

The Galaxy 500/800E is positioned at the premium end of the single-head commercial embroidery market — delivering the embroidery area, needle capacity, and build quality required by serious embroidery businesses, fashion houses, and high-volume uniform decorators.`,
      features: [
        '500×800mm embroidery field — full back designs and large logo capability',
        '12-needle head — automatic switching between 12 thread colours',
        'Premium single-head commercial embroidery machine',
        'High-precision stitch formation for complex multi-colour designs',
        'Galaxy brand — premium industrial embroidery performance',
      ],
      specifications: {
        'Brand': 'Galaxy',
        'Model': '500/800E',
        'Embroidery Area': '500mm × 800mm',
        'Head Configuration': 'Single head',
        'Needles': '12 needles (12-colour automatic switching)',
        'Machine Type': 'Industrial Monogram/Embroidery Machine',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['galaxy', '500/800e', 'monogram', 'embroidery machine', '12 needle', 'single head', 'industrial', 'premium'],
    },
    {
      name: 'Two Lion S7 Monogram Machine',
      slug: 'two-lion-s7-monogram',
      brand: 'Two Lion',
      categoryId: catEmbroidery.id,
      subcategory: 'Monogram',
      price: 1950000,
      images: [PH],
      shortDescription: 'Two Lion S7 single-head 12-needle industrial monogram (embroidery) machine for multi-colour logos, personalised garments, and branded uniforms.',
      description: `The Two Lion S7 is a single-head, 12-needle commercial monogram machine from Two Lion, one of the most recognised industrial sewing machine brands in Nigerian and West African markets. The S7 configuration delivers automatic 12-colour switching, allowing complex multi-colour embroidery designs to be executed without manual re-threading between colour changes.

The Two Lion S7 is a reliable, production-tested choice for embroidery businesses and uniform decorators seeking dependable commercial embroidery performance from a brand with strong local support and service networks across Nigeria.`,
      features: [
        '12-needle head — automatic switching between 12 thread colours',
        'No manual re-threading for colour changes — maximises production efficiency',
        'Single-head S7 format for precision commercial embroidery',
        'Two Lion brand — strong local support and service network in Nigeria',
        'Suitable for logos, personalised garments, and branded uniform decoration',
      ],
      specifications: {
        'Brand': 'Two Lion',
        'Model': 'S7',
        'Head Configuration': 'Single head',
        'Needles': '12 needles (12-colour capacity)',
        'Best For': 'Multi-colour logos, branded uniforms, monograms, personalised garments',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['two lion', 's7', 'monogram', 'embroidery machine', '12 needle', 'single head', 'multi-colour', 'industrial'],
    },

    // ═══════════════════════════════════════════════════════════════════════
    //  BATCH 4 ADDITIONS — DISPLAY & ACCESSORIES (MANNEQUINS)
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Plastic Kodo Male Mannequin',
      slug: 'plastic-kodo-male-mannequin',
      brand: 'Generic',
      categoryId: catDisplay.id,
      subcategory: 'Male Mannequin',
      price: 50000,
      images: [PH],
      shortDescription: 'Plastic male mannequin (kodo style) for displaying shirts, suits, and menswear in boutiques and tailoring shops.',
      description: `The Plastic Kodo Male Mannequin is a full-body male mannequin for displaying shirts, suits, trousers, and menswear in retail boutiques, tailoring shops, and market stalls. Built from durable matte-finish plastic in natural male body proportions, it provides a realistic presentation surface for garments.

The kodo-style form offers clean, simple proportions suitable for displaying a wide range of menswear styles including formal wear, casual clothing, and tailored garments. Lightweight and easy to move and reposition for seasonal displays or shop layout changes.`,
      features: [
        'Full-body male mannequin for menswear display',
        'Durable matte plastic construction',
        'Natural male body proportions for realistic garment presentation',
        'Lightweight and easy to reposition for display changes',
        'Suitable for boutiques, tailoring shops, and market stalls',
      ],
      specifications: {
        'Type': 'Full body male mannequin (kodo style)',
        'Material': 'Durable plastic',
        'Finish': 'Matte',
        'Use Cases': 'Shirts, suits, trousers, menswear display',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: null,
      tags: ['male mannequin', 'kodo', 'plastic mannequin', 'display', 'menswear', 'boutique', 'tailoring'],
    },
    {
      name: 'Full Body Plastic Male Mannequin (With Beard)',
      slug: 'plastic-male-mannequin-with-beard',
      brand: 'Generic',
      categoryId: catDisplay.id,
      subcategory: 'Male Mannequin',
      price: 60000,
      images: [PH],
      shortDescription: 'Full body plastic male mannequin with sculpted beard detail — ideal for displaying menswear, agbada, and traditional Nigerian fashion.',
      description: `The Full Body Plastic Male Mannequin with Beard features sculpted facial detail including a beard, giving a more realistic and distinguished male form for displaying fashion. The bearded mannequin is especially popular in Nigerian boutiques for displaying agbada, suits, native wear, and contemporary menswear where a complete, styled male form enhances the visual presentation.

Full body construction including head, torso, arms, and legs provides a complete display surface for coordinating full outfits — from shoes and trousers to shirts and jackets — in a single display.`,
      features: [
        'Full body with sculpted beard detail for realistic male presentation',
        'Complete head-to-toe form for coordinating full outfit displays',
        'Durable plastic construction for long-lasting boutique use',
        'Popular for agbada, suits, native wear, and contemporary menswear',
        'Adds distinguished character to menswear retail displays',
      ],
      specifications: {
        'Type': 'Full body male mannequin with beard',
        'Material': 'Durable plastic',
        'Features': 'Sculpted beard facial detail',
        'Use Cases': 'Suits, agbada, native wear, menswear display',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: null,
      tags: ['male mannequin', 'beard mannequin', 'plastic mannequin', 'display', 'agbada', 'menswear', 'boutique'],
    },
    {
      name: "Unisex Plastic Children's Mannequin",
      slug: 'plastic-children-mannequin-unisex',
      brand: 'Generic',
      categoryId: catDisplay.id,
      subcategory: "Children's Mannequin",
      price: 35000,
      images: [PH],
      shortDescription: "Unisex plastic children's mannequin for displaying kids' clothing, school uniforms, and children's fashion in boutiques and shops.",
      description: `The Unisex Plastic Children's Mannequin is a child-scale display form suitable for showcasing kids' clothing, school uniforms, children's fashion, and baby wear. The unisex form works for both boys' and girls' clothing, making it a versatile addition to children's boutiques, school uniform shops, and kids' clothing sections of fashion stores.

Lightweight and easy to dress and undress, the children's mannequin provides an appealing, realistic display of children's garments that helps customers visualise the fit and style before purchase.`,
      features: [
        "Unisex child-scale form for both boys' and girls' clothing",
        "Ideal for school uniforms, children's fashion, and baby wear display",
        'Lightweight and easy to dress and undress',
        "Realistic child proportions for accurate garment presentation",
        "Durable plastic construction for long-lasting shop use",
      ],
      specifications: {
        'Type': "Unisex children's mannequin",
        'Material': 'Durable plastic',
        'Gender': 'Unisex',
        'Use Cases': "School uniforms, kids' fashion, children's boutiques",
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: null,
      tags: ["children's mannequin", 'kids mannequin', 'plastic mannequin', 'unisex', 'school uniform', 'display'],
    },
    {
      name: 'Female Plastic Mannequin (Headless)',
      slug: 'female-plastic-mannequin-headless',
      brand: 'Generic',
      categoryId: catDisplay.id,
      subcategory: 'Female Mannequin',
      price: 30000,
      images: [PH],
      shortDescription: 'Female plastic mannequin (headless) for displaying dresses, tops, and womenswear in boutiques and fashion stalls.',
      description: `The Female Plastic Mannequin (Headless) is a full torso and leg female form without a head — the headless configuration is popular in Nigerian fashion retail for its clean, minimal look that keeps focus on the garment rather than the face. It displays dresses, skirts, trousers, and tops effectively in boutiques, market stalls, and fashion exhibitions.

The headless form is practical for shops where ceiling height or display space is limited, and for retailers who prefer garments to take centre stage. Made from durable plastic with a finish that suits a wide range of retail environments.`,
      features: [
        'Headless female form — keeps focus on the garment display',
        'Full torso and leg form for displaying dresses, skirts, and trousers',
        'Popular configuration for Nigerian fashion boutiques and market stalls',
        'Compact display footprint — suitable for limited ceiling height spaces',
        'Durable plastic construction for daily retail use',
      ],
      specifications: {
        'Type': 'Headless female mannequin',
        'Material': 'Durable plastic',
        'Configuration': 'Full torso and legs, no head',
        'Use Cases': 'Dresses, skirts, trousers, tops, womenswear display',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: null,
      tags: ['female mannequin', 'headless mannequin', 'plastic mannequin', 'womenswear', 'display', 'boutique'],
    },
    {
      name: 'Female Plastic Mannequin (Armless)',
      slug: 'female-plastic-mannequin-armless',
      brand: 'Generic',
      categoryId: catDisplay.id,
      subcategory: 'Female Mannequin',
      price: 20000,
      images: [PH],
      shortDescription: 'Female plastic mannequin (armless) — a compact, lightweight display form for tops, dresses, and womenswear.',
      description: `The Female Plastic Mannequin (Armless) is a female torso display form without arms — a compact, lightweight option for displaying tops, blouses, dresses, and womenswear where a full-figure form is not required or space is limited.

The armless configuration is among the most affordable mannequin options and is widely used in Nigerian market stalls, small boutiques, and fashion exhibitions where multiple display forms are needed across a stall layout. Simple to position and easy to dress and undress quickly between displays.`,
      features: [
        'Armless female form — compact, lightweight, and easy to handle',
        'Cost-effective display solution for high-volume retail stalls',
        'Displays tops, blouses, dresses, and womenswear effectively',
        'Easy to dress and undress quickly for busy retail environments',
        'Durable plastic for long-lasting daily retail use',
      ],
      specifications: {
        'Type': 'Armless female mannequin',
        'Material': 'Durable plastic',
        'Configuration': 'Torso without arms',
        'Use Cases': 'Tops, blouses, dresses, womenswear display',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: null,
      tags: ['female mannequin', 'armless mannequin', 'plastic mannequin', 'womenswear', 'display', 'market stall'],
    },
    {
      name: 'Mannequin Head – Cap and Hat Display',
      slug: 'mannequin-head-cap-display',
      brand: 'Generic',
      categoryId: catDisplay.id,
      subcategory: 'Display Head',
      price: 45000,
      images: [PH],
      shortDescription: 'Mannequin head for displaying caps, hats, and headwear in boutiques and fashion stalls.',
      description: `The Mannequin Head for Cap and Hat Display is a life-size head form designed specifically for displaying caps, hats, headbands, and headwear accessories. Positioned at eye level on a stall or shelf, it provides a realistic, styled presentation of headwear that flat or hanging display cannot achieve.

Widely used in Nigerian fashion boutiques, cap vendors, hat shops, and accessories stalls. The mannequin head is also useful for displaying wigs, head scarves, and hair accessories. Made from durable material with a neutral finish that complements any retail environment.`,
      features: [
        'Life-size head form for realistic cap and hat display',
        'Ideal for caps, hats, headbands, wigs, and hair accessories',
        'Elevated display draws customer attention to headwear products',
        'Neutral finish suitable for any retail or stall environment',
        'Durable construction for long-lasting daily display use',
      ],
      specifications: {
        'Type': 'Mannequin head — cap and hat display',
        'Material': 'Durable display material',
        'Finish': 'Neutral',
        'Use Cases': 'Caps, hats, headbands, wigs, hair accessories display',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: null,
      tags: ['mannequin head', 'cap display', 'hat display', 'headwear', 'wig display', 'boutique', 'accessories'],
    },
    {
      name: 'Full Pinnable Size 10 Female Mannequin',
      slug: 'pinnable-size-10-female-mannequin',
      brand: 'Generic',
      categoryId: catDisplay.id,
      subcategory: 'Female Mannequin',
      price: 220000,
      images: [PH],
      shortDescription: 'Full pinnable size 10 female mannequin — foam-padded surface allows tailors to pin garments directly for fitting and adjustment.',
      description: `The Full Pinnable Size 10 Female Mannequin is a professional dress form in Size 10 proportions with a fully pinnable foam-padded surface. The pinnable construction allows tailors and fashion designers to pin garments, seams, and alterations directly onto the form during pattern fitting and garment construction — making it an essential tool for bespoke tailoring and couture work.

Size 10 is one of the most common dress sizes in the Nigerian and UK fashion market, making this form versatile for everyday garment fitting work. Suitable for displaying fitted garments and used as a working dress form in tailoring workshops and fashion design studios.`,
      features: [
        'Fully pinnable foam-padded surface for direct garment pinning',
        'Size 10 proportions — widely used in Nigerian and UK fashion',
        'Professional dress form for bespoke tailoring and couture fitting',
        'Display mannequin and working dress form in one',
        'Suitable for pattern fitting, alterations, and garment construction',
      ],
      specifications: {
        'Size': 'Size 10',
        'Surface': 'Fully pinnable foam/padded',
        'Use Cases': 'Garment fitting, pattern draping, retail display, tailoring',
        'Best For': 'Bespoke tailoring workshops, fashion design studios, boutiques',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: null,
      tags: ['mannequin', 'pinnable', 'size 10', 'female mannequin', 'dress form', 'tailoring', 'fitting', 'fashion design'],
    },

    // ═══════════════════════════════════════════════════════════════════════
    //  BATCH 4 ADDITIONS — BUTTON & BUTTONHOLE
    // ═══════════════════════════════════════════════════════════════════════
    {
      name: 'Sewtec Industrial Tacking Button Machine',
      slug: 'sewtec-industrial-tacking-button',
      brand: 'Sewtec',
      categoryId: catButton.id,
      subcategory: 'Button Tacking',
      price: 720000,
      images: [PH],
      shortDescription: 'Sewtec industrial tacking button machine for high-speed automated button attachment in garment factories and tailoring workshops.',
      description: `The Sewtec Industrial Tacking Button Machine is a high-speed automated button sewing machine designed for the rapid, secure attachment of buttons to garments in production environments. It produces a tight, accurate tack stitch that firmly secures flat and shanked buttons without manual hand-sewing — dramatically increasing output compared to traditional methods.

Sewtec machines are built for demanding production environments where consistent, high-volume button attachment is required. Suitable for shirt factories, uniform production lines, and large tailoring workshops producing formal wear, work shirts, and school uniforms at volume.`,
      features: [
        'High-speed automated button tacking for production-rate attachment',
        'Secures flat and shanked buttons with accurate, consistent tack stitch',
        'Eliminates manual hand-sewing for dramatic production speed gains',
        'Sewtec brand — industrial tacking machines for demanding environments',
        'Suitable for shirts, uniforms, formal wear, and high-volume production',
      ],
      specifications: {
        'Brand': 'Sewtec',
        'Machine Type': 'Industrial Button Tacking Machine',
        'Button Types': 'Flat and shanked buttons',
        'Stitch Pattern': 'Tack stitch (automated cycle)',
        'Best For': 'Shirt factories, uniform production, formal wear, school uniforms',
      },
      inStock: true,
      stockCount: 1,
      isFeatured: false,
      ...
      badge: 'New',
      warranty: '1 Year Warranty',
      tags: ['sewtec', 'tacking machine', 'button machine', 'industrial', 'automated', 'garment production', 'shirts', 'uniforms'],
    },
  ];
  ...
  await prisma.product.update({
    where: { slug: 'jukae-boiler-industrial-steam-iron' },
    data: { price: 350000 },
  });
  console.log('  ✅ Jukae Boiler Industrial Steaming Iron → ₦350,000');
